...
public final class TermuxConstants {
    ...
    /** Termux app name */
    public static final String TERMUX_APP_NAME = "Tux"; // Default: "Termux"
    /** Termux package name */
    public static final String TERMUX_PACKAGE_NAME = "com.umarbabur.tux"; // Default: "com.termux"
    ...
    public static final class TERMUX_APP {
        ...
        /** Termux app BuildConfig class name (uses Java namespace, not applicationId) */
        public static final String BUILD_CONFIG_CLASS_NAME = "com.termux.BuildConfig"; // Default: "com.termux.BuildConfig"

        /** Termux app FileShareReceiverActivity class name (uses Java namespace) */
        ...
        /** Termux app FileViewReceiverActivity class name (uses Java namespace) */
        ...
        /** Termux app core activity name (uses Java namespace). */
